-- 1. Sales table mein notes ka column banayein
ALTER TABLE public.sales ADD COLUMN IF NOT EXISTS notes text;

-- 2. Asal aur Mukammal Function (Bina kisi comment ya line ko hazaf kiye)
...
BEGIN
    ...
    INSERT INTO public.sales (
        ...
        (p_sale_record->>'notes')::TEXT -- <--- NAYI VALUE (AUDIT NOTES)
    ) 
