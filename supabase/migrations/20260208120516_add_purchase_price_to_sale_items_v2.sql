-- 1. Sale Items table mein purchase_price ka column add karein
ALTER TABLE public.sale_items 
ADD COLUMN IF NOT EXISTS purchase_price numeric DEFAULT 0;

-- 2. Aapka Asal Function (Baghair kisi hazaf ya ikhtisaar ke)
CREATE OR REPLACE FUNCTION public.process_sale_atomic(p_sale_record jsonb, p_sale_items jsonb, p_inventory_updates jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
