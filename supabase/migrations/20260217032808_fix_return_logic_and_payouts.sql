-- Phase 4: Fixing Return Logic to support Debt-First Refund
-- Updating the atomic sale return function while strictly respecting existing logic and comments
