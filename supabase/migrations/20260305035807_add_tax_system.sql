-- 1. Profiles (Settings) table mein Tax ke columns add karna
...
-- 2. Sales table mein Tax ki raqam save karne ke liye columns add karna
ALTER TABLE public.sales 
ADD COLUMN IF NOT EXISTS tax_amount NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS tax_rate_applied NUMERIC DEFAULT 0;

-- 3. Sale Returns table mein wapis kiye gaye Tax ka record rakhne ke liye column add karna
ALTER TABLE public.sale_returns
ADD COLUMN IF NOT EXISTS tax_refunded NUMERIC DEFAULT 0;

-- 4. Sale Save karne wale function (RPC) ko update karna taake wo Tax bhi save kare
...
-- 5. Sale Return wale function (RPC) ko update karna taake wapis kiya gaya Tax bhi save ho
...
BEGIN
    ...
    VALUES (
        ...
        COALESCE((p_return_record->>'tax_refunded')::NUMERIC, 0), -- <--- NAYI VALUE (TAX)
